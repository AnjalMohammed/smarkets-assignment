...
export const EventDetailsPage = () => {
    ...
    return (
        <>
            ...
            <Card>
                <p><span className="bold">Name:</span> {currentEvent.name}</p>
                <p><span className="bold">Starts On:</span>  {moment(currentEvent.start_datetime).format('LLL')}</p>
                <p><span className="bold">Can you bet?:</span> {currentEvent.bet_allowed ? 'Yes' : 'No'}</p>
                <p><span className="bold">Short Name:</span> {currentEvent.short_name || '-'}</p>
                <p><span className="bold">Description:</span> {currentEvent.description || '-'}</p>
